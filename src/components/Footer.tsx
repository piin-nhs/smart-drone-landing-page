                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <input
                      ...
                      className="w-full h-10 px-3 bg-background border border-card-border rounded-none text-base sm:text-xs placeholder:text-[11px] sm:placeholder:text-xs text-foreground focus:outline-none focus:border-foreground/40 transition-colors disabled:opacity-50 font-sans"
                    />
                    {errors.fullName && (
